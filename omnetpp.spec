...
Summary(pl.UTF-8):	OMNeT++ - zorientowane obiektowo środowisko do symulacji zdarzeń dyskretnych
Name:		omnetpp
Version:	3.1
Release:	0.4
License:	academic
...
OMNeT++ to bogate w możliwości, oparte na C++, zorientowane obiektowo
środowisko do symulacji zdarzeń dyskretnych, głównie przeznaczone do
